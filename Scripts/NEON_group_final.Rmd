...
sampled_points1<-extract(all.data, soap_insitu, buffer=buffers, small=TRUE)
...
# combine
sampled_points<-do.call(rbind, sampled_points1)
head(sampled_points)
...
#### Withhold 20 % of insitu for validataion - or is this included in random forest??
training<-
validation<-
```
